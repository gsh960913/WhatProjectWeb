...
<div class="w3-sidebar w3-bar-block w3-card w3-animate-left" style="display:none" id="leftMenu">
  ...
  <a href="#" class="w3-bar-item w3-button"><font color=#FAFAFA>시스템 보안</font></a>
  ...
  <a href="#" class="w3-bar-item w3-button"><font color=#FAFAFA>부가기능</font></a>
   ...
   <!-- 로그아웃 부분 -->            
  	 ...
  	 <div class="container">
  	 	<div class="row">
  	 		<ul class="list-group">
  	 			<a href="lecture.jsp" class="list-group-item active"> 1장 Metasploit Framework 사용하기</a>
  	 			<a href="lecture2.jsp" class="list-group-item"> 2장 Nmap 사용하기</a>
