...
<body>
 ...
 <!-- 사이드바 content -->
	...
	<div class="navbar-header" style="margin-left:20px;">
            ...
            <a class="log" href="index.jsp"><img style="margin-top: 40px; margin-left:15px; margin-bottom:15px;"  src="images/whitehat.jpg" width="200" height="70" ></a>
         </div>
            ...
            <div class="col-sm-6" style="background-color: rgba( 255, 255, 255, 0.2 ) ">
               ...
               <br>
                     <div class="embed-responsive embed-responsive-16by9">
                        <br>
                        <iframe class="asd"  src="https://www.youtube.com/embed/O-tMd3rAujo"></iframe>
                     </div>
                     <br>
                    <p><a class="btn btn-default" href="index6.jsp">자세히 알아보기</a></p>
            </div>
            <div class="col-sm-6" style="background-color: rgba( 255, 255, 255, 0.2 )" >
