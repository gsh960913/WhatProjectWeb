 ...
 <!-- 사이드바 content -->
	...
	<div class="navbar-header" style="margin-left:20px;">
         ...
         <div class="topMenu collapse navbar-collapse " id="bs-example-navbar-collapse-1">
            <ul class="menu01 nav" style="text-align:center;">
               <li>
               ...
               <li>
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown"
                     aria-haspopup="true" aria-expanded="false"><span>Q & A</span></a>
                   <ul class="dept01">
                        <li id="nop"><a href="lecture.jsp"></a></li>
                        <li id="nop"><a href="lecture.jsp"></a></li>
                        <li id="nop"><a href="lecture.jsp"></a></li>
 ...
 <div id="myCarousel" class="carousel slide" data-ride="carousel"> 
   ...
   <ol class="carousel-indicators">
      ...
      <div class="item active"> 
         <img src="images/ApplicationImage.png"  style="width: 100%; data-src=""  alt="Second slide">
         <div class="container">
         </div>
      </div>
      <div class="item"> 
         <img src="images/NetworkImage.jpg"  style="width: 100%; data-src=""  alt="Second slide">
         <div class="container">
         </div>
      </div>
      <div class="item"> 
         <img src="images/SystemImage.png" style="width: 100%; data-src=""  alt="Third slide">
         <div class="container">
         </div>
      </div>
      <div class="item"> 
         <img src="images/WebImage.png" style="width: 100%; data-src=""  alt="Third slide">
         <div class="container">
         </div>
      </div>
   </div>
